...
"""
This code is extracted from Toshi Omagari's Nudge-move by Numerical Value
published in https://github.com/Tosche/Glyphs-Scripts/blob/master/Path/Nudge-Move%20by%20Numerical%20Value.py
